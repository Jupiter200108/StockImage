...
Item.create!(
 [
  ...
  {name: 'ビットコイン取引する男女', content: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/illustration7.jpg"), filename:"illustration7.jpg"), introduction: 'ビットコイン取引に関わる男女の絵となっています。test', end_user_id: users[7].id,category_id: categories[6].id,genre_id: genres[1].id,is_active: "true"},
